<x-front.layout title="Rapa Cast Stone | Produsen Cast Stone Berkualitas Indonesia"
    ...
    <section class="py-32 px-6 bg-[#F5F1E8]">
        <div class="max-w-7xl mx-auto">
            <p class="text-center text-xs text-[#8B7F6E] tracking-[2px] uppercase mb-4 font-normal">Artikel Terbaru</p>
            <h2 class="font-heading text-5xl md:text-6xl text-center mb-20 tracking-wide font-light">Wawasan &
                Inspirasi</h2>
                ...
                @foreach ($latestArticles as $article)
                    <div class="group cursor-pointer">
                        <div class="overflow-hidden mb-6 shadow-md hover:shadow-xl transition-shadow duration-500">
                            <img src="{{ $article->image ? asset('storage/' . $article->image) : 'https://images.unsplash.com/photo-1615529182904-14819c35db37?w=400' }}"
                                alt="{{ $article->title }}"
                        ...
                        <div class="pr-4">
                            ...
                            <a href="{{ url('/articles/' . $article->slug) }}"
                                class="text-xs tracking-[2px] uppercase text-[#3A352F] border-b border-[#3A352F] pb-1 hover:text-[#6B5E52] hover:border-[#6B5E52] transition-all">Baca
                                Selengkapnya</a>
                        </div>
                    </div>
                @endforeach
